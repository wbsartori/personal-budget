...
export function Income() {
    ...
    useEffect(() => {
        axios('http://localhost:3434/income')
            .then(response => {
        ...
        <>
            ...
            <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                ...
                <tr>
                    ...
                    <th scope="col" className="py-3 px-6">Pessoa</th>
                ...
                {incomes.map((income, index) => {
                        return (
                            <tr key={index}
                                ...
                                <td className="py-4 px-6">{income.id}</td>
                                <td className="py-4 px-6">{income.idPerson}</td>
                                <td className="py-4 px-6">{income.description}</td>
                                <td className="py-4 px-6">{income.incomeDate}</td>
                                <td className="py-4 px-6">{income.value}</td>
